# Hackberry-Pi-Zero
A handheld Linux terminal using Raspberry Pi Zero 2W as Core with a 4" 720X720 TFT display and the original BlackBerry Keyboard
...
The main reason why I designed and built this handheld cyberdeck is to be used as a learning tool, a portablle toy for hackers. It is powered by a Raspberry Pi Zero 2w and a 4" 720X720 TFT display. 
...
**Battery Life**: In my testing: 3.5 hours using the desktop, and 5 hours on the command line.  
**Keyboard & Touchpad as Mouse**: Yes, this cyberdeck has a keyboard and mouse on board. You can choose a Blackberry Q10 or Q20 keyboard.  
**Fully customizable keymap**: You can connect the keyboard to a computer and customize the keymap through [VIAL](https://get.vial.today/) easily.  
**3 USB2.0 Ports**: This handheld has 3 USB2.0 Ports, you can use it with a USB-Stick or 4G Module Dongle or any USB thing.  
...
## Block Diagram
![Blockdiagramm_HackberryPi_Zero](https://github.com/CarbonComputers/HackberryPi-Zero/blob/main/Mechanical-Drawing/HackberryPi%20Diagram.png)
...
There is a red switch on the left side to decide if the keyboard controller communicates with the HackberryPi or with another device through the USBC-Port underneath.  
The idea about this is you can connect the keyboard to your computer and customize the keymap using [VIAL](https://get.vial.today/) or the handheld can be used as an emergency keyboard-mouse.

![keyboard](https://github.com/user-attachments/assets/63ac5772-f248-4117-bd29-ae0b3058e1e4)
### How to change the keymap?  
Put the red switch to the lower position, connect the keyboard to your computer, open [VIAL page](https://vial.rocks/), then you can customize the keymap yourself.

![image](https://github.com/CarbonComputers/HackberryPi-Zero/blob/main/Images/full-view.png)
![image](https://github.com/CarbonComputers/HackberryPi-Zero/blob/main/Images/layer0.png)
![image](https://github.com/CarbonComputers/HackberryPi-Zero/blob/main/Images/layer1.png)
![image](https://github.com/CarbonComputers/HackberryPi-Zero/blob/main/Images/layer2.png)
...
Weight without battery: 151.7 Grams  
Weight with battery: 189.7 Grams

![Drawing](https://github.com/CarbonComputers/HackberryPi-Zero/blob/main/Mechanical-Drawing/HackberryPi%20Blueprint.png)  
# <a name='Where to buy in the US '>Where to buy in the US</a>
[HackBerryPi Zero](https://carboncomputers.us/products/hackberrypi-with-cyberpunk-case)  

# <a name='Where to buy from China '>Where to buy from China</a>
[HackBerryPi Zero](https://www.elecrow.com/hackberrypi-zero-with-bb9900-keyboard.html)  
